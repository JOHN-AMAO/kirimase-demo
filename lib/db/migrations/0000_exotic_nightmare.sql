...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "reflecions" (
	"id" varchar(191) PRIMARY KEY NOT NULL,
	"content" varchar(256) NOT NULL,
	"book_id" varchar(256) NOT NULL,
	"user_id" varchar(256) NOT NULL,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "reflecions" ADD CONSTRAINT "reflecions_book_id_books_id_fk" FOREIGN KEY ("book_id") REFERENCES "books"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
